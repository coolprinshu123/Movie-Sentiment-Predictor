...
def trainFile(trainPath="Train.txt",featurePath="selected-features-indices.txt",error = 0.0):
...
print "\n Noise = 0.5 "
tree = trainFile(trainPath,featurePath,0.003)
x = testFile(tree)
print "\n Noise = 1 "
tree = trainFile(trainPath,featurePath,0.006)
x = testFile(tree)
print "\n Noise = 5 "
tree = trainFile(trainPath,featurePath,0.025)
x = testFile(tree)
print "\n Noise = 10 "
tree = trainFile(trainPath,featurePath,0.05)
x = testFile(tree)
