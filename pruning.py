...
def removeNode(head,tree,accu,trainPath = "Train.txt",testPath = "Test.txt"):
	q = []
	q.append(tree)
	while(len(q)!=0):
		x = q.pop(0)
...
def pruning(tree,accu):
	newTree = removeNode(tree,tree,accu)
	return newTree
...
x = testFile(tree,testPath)
outputTree = pruning(tree,x)
print "Final accuracy of the prunned tree is : "
t = testFile(output,"Test2.txt")
